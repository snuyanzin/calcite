...
| DOY(date)                 | Equivalent to `EXTRACT(DOY FROM date)`. Returns an integer between 1 and 366.
...
| {fn DOY(date)} | Equivalent to `EXTRACT(DOY FROM date)`. Returns an integer between 1 and 366.
