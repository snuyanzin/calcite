...
public enum BuiltInMethod {
  ...
  MULTISET_INTERSECT(SqlFunctions.class, "multisetIntersect", Collection.class, Collection.class),
  MULTISET_INTERSECT_ALL(SqlFunctions.class, "multisetIntersectAll",
      Collection.class, Collection.class),
  MULTISET_EXCEPT(SqlFunctions.class, "multisetExcept", Collection.class, Collection.class),
  MULTISET_EXCEPT_ALL(SqlFunctions.class, "multisetExceptAll",
          Collection.class, Collection.class),
  MULTISET_UNION(SqlFunctions.class, "multisetUnion", Collection.class, Collection.class),
  ...
  SUBMULTISET_OF(SqlFunctions.class, "isSubMultisetOf", Collection.class, Collection.class),
