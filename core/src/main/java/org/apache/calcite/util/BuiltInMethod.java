...
public enum BuiltInMethod {
  ...
  UNIX_TIMESTAMP_CEIL(DateTimeUtils.class, "unixTimestampCeil",
      TimeUnitRange.class, long.class),
  AGE(SqlFunctions.class, "age", Long.class, Long.class, DataContext.class),
  AGE_ONE_TIMESTAMP(SqlFunctions.class, "age", Long.class, DataContext.class),
  AGE_TWO_TIMESTAMPS(SqlFunctions.class, "age", Long.class, Long.class),
